...
#   end
User.create(email: "user1@gmail.com" ,password: 123456 ,first_name: "user1",last_name: "lastname_user1")
User.create(email: "user2@gmail.com" ,password: 123456, first_name: "user2",last_name: "lastname_user2")
User.create(email: "user3@gmail.com" ,password: 123456, first_name: "user3",last_name: "lastname_user3")
User.create(email: "user4@gmail.com" ,password: 123456, first_name: "user4",last_name: "lastname_user4")
User.create(email: "user5@gmail.com" ,password: 123456, first_name: "user5",last_name: "lastname_user5")
User.create(email: "user6@gmail.com" ,password: 123456, first_name: "user6",last_name: "lastname_user6")
User.create(email: "user7@gmail.com" ,password: 123456, first_name: "user7",last_name: "lastname_user7")
User.create(email: "user8@gmail.com" ,password: 123456, first_name: "user8",last_name: "lastname_user8")
User.create(email: "user9@gmail.com" ,password: 123456, first_name: "user9",last_name: "lastname_user9")
User.create(email: "user10@gmail.com",password: 123456, first_name: "user10",last_name:"lastname_user10")
